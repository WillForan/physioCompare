...
# looks like mean age is actuall 14.86196 instead of 15.45362!! why?
meanage<-14.86196
plotmodelwithpoints <- function(model, gtitle) {
        # two data sets
	...
	ggsave(plot.simple,file=sprintf("imgs/lm/ageinv/devel/%s-simple.png",gtitle))
	ggsave(plot.all,file=sprintf("imgs/lm/ageinv/devel/%s-all.png",gtitle))
